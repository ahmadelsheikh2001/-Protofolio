...
const HomeData = () => {
  ...
  return (
    <>
      <AdminCards>
        <Form type='home_page' setData={setDownloadedData} data={downloadedData} resource={resourceData}/>
      </AdminCards>
      <AdminCards>
        <Compaines resource={resourceData2} type='home_page' curretnCompany={curretnCompany} />
      </AdminCards>
    </>
  )
}
