  ...
  const resourceWhyMe = [
    {
      ...
      placeHolder: "قم بإدخال عدد سنوات الخبرة",
      id: "exp_years",
      type: "text",
    },
    {
      text: "عدد المشاريع",
      placeHolder: "قم بإدخال عدد المشاريع",
      id: "projects",
      type: "text",
    },
    {
      text: "عدد العملاء",
      placeHolder: "قم بإدخال عدد العملاء",
      id: "clients",
      type: "text",
    },
    {
      text: "ساعات الدعم",
      placeHolder: "قم بإدخال ساعات الدعم",
      id: "hours",
      type: "text",
    },
  ];
