...
const UiProjectsList = ({ type, setProjects, projects, designType }) => {
  ...
  let filterdData = projects
  if (search) filterdData = filterdData.filter((ele) => ele?.name?.includes(search) || ele?.description?.includes(search))
  ...
  return (
    <>
      ...
      <div className="table_filter" style={{display:"flex",justifyContent:"space-around"}}>
